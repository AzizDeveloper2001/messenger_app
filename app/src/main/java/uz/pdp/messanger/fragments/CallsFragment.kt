...
import uz.pdp.messanger.databinding.FragmentCallsBinding
    ...
    override fun onCreateView(
        ...
        binding.searchview.setOnQueryTextListener(object : SearchView.OnQueryTextListener{
            ...
            override fun onQueryTextChange(newText: String?): Boolean {
                ...
                for (a in list){
                    if(a.firstname.toString().lowercase().contains(newText?.lowercase()!!)){
                        newList.add(a)
                    }
                }
                callAdapter.updatelist(newList)
                    ...
                    if(userData!=null){
                        ...
                        ref.addValueEventListener(object : ValueEventListener {
                            override fun onDataChange(snapshot: DataSnapshot) {
                                ...
                                callAdapter= CallAdapter(list,object :CallAdapter.onItemClick{
